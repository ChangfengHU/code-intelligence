...
class QwenAIService(private val config: AIConfig) : AIService {
    ...
    private val baseUrl = "https://dashscope.aliyuncs.com/api/v1/services/aigc/text-generation/generation"
    ...
    override fun translateCode(code: String): String {
        ...
        try {
            ...
            throw IOException("阿里千问代码翻译失败: ${e.message}")
        }
    }
    ...
    private fun parseQwenResponse(jsonResponse: String): String {
        try {
            ...
            throw IOException("解析阿里千问响应失败: ${e.message}")
        }
    }
