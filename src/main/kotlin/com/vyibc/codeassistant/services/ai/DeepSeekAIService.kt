...
class DeepSeekAIService(private val config: AIConfig) : AIService {
    ...
    override fun translateCode(code: String): String {
        ...
        try {
            ...
            throw IOException("DeepSeek代码翻译失败: ${e.message}")
        }
    }
    ...
    private fun parseDeepSeekResponse(jsonResponse: String): String {
        try {
            ...
            throw IOException("解析DeepSeek响应失败: ${e.message}")
        }
    }
